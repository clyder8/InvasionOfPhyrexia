...
namespace PhyrexiaMod.Content.Gores
{
    public class PhyrexianFrontierWaterDroplet : ModGore
    {
        ...
        public override bool Update(Gore gore)
        {
            ...
            if (gore.Frame.CurrentRow <= 4)
            {
                ...
                if (Terraria.WorldGen.InWorld(tileX, tileY, 0) && !Main.tile[tileX, tileY].HasTile)
                    gore.active = false;
